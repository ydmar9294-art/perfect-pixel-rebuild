        ...
        <div className="max-w-md space-y-6 animate-zoom-in">
          ...
          <div className="pt-8 flex flex-col gap-3">
            <a
              ...
              className="w-full py-4 bg-green-500 text-white rounded-2xl font-black shadow-xl transition-transform active:scale-95 flex items-center justify-center gap-2"
            >
